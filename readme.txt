...
----main---
in main complex objects are defined and initialized. linked list is created and complex objects are stored. respected operations are performed and values are stored in a new complex object. the values are displayed usig traverse function.
